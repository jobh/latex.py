...
\newcommand{\twofig}[6][] {
  \begin{figure}
    \ffigbox[#1]
    {
      \subfloat[\draft{\bf\tiny[#2] }#3]{\label{fig:#2:a}\includegraphics{data/#2}}
      \subfloat[\draft{\bf\tiny[#4] }#5]{\label{fig:#2:b}\includegraphics{data/#4}}
    }
    {\caption{#6}\label{fig:#2}}
  \end{figure}
}
