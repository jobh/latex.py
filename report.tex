...
\reffig{symm/Q0,RT1,Q1,-} for constant load and \reffig{asymm/Q0,RT1,Q1,Q0} for
non-constant load.
...
\fig[width=\textwidth]{symm/Q0,RT1,Q1,-}{Correct solution for the constant-load
problem. From left to right: $\epsilon=10^{-1}$, $\epsilon=10^{-4}$, $\epsilon=10^{-14}$.}
\fig[width=\textwidth]{asymm/Q0,RT1,CR1,Q0}{Correct solution for the variable-load
problem. From left to right: $\epsilon=10^{-1}$, $\epsilon=10^{-4}$, $\epsilon=10^{-14}$.}
...
\item If elastic locking is the cause of pressure oscillations, it should be
  ...
  (impermeable) layer. See \reffig{asymm/P2,-,P2,-,EPS-14:asymm/P2,-,P2+,P1-}. This is
  probably the most powerful argument.
\item The impermeable layer does \emph{not} force $\U$ to be constant. The
  incompressible layer does. See \reffig{u-locking}. Hence, locking is not
