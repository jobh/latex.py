...
This example is shown in \reffig{domain}, parameterised by $\epsilon<1$.
...
\fig[width=\textwidth]{symm/Q1,-,Q1,-}{Uniform load}
\fig[width=\textwidth]{symm/Q0,RT1,Q1,-}{Uniform load, mixed-$\Pf$}

\fig[width=\textwidth]{asymm/Q1,-,Q1,-}{Asymmetric load}
\fig[width=\textwidth]{asymm/Q0,RT1,Q1,-}{Asymmetric load, mixed-$\Pf$}
